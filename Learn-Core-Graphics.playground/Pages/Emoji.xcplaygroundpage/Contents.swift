...
let rendered = renderer.image { ctx in
    ...
    let leftEye = CGRect(x: 300, y: 300, width: 100, height: 100)
    let rightEye = CGRect(x: 600, y: 300, width: 100, height: 100)
    ...
    let mouth = CGRect(x: 400, y: 500, width: 300, height: 300)
