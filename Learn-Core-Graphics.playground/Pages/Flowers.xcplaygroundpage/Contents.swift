...
let rendered = renderer.image { ctx in
    ...
    let circle2 = CGRect(x: 100, y: 400, width: 500, height: 500)
    let circle3 = CGRect(x: 400, y: 100, width: 500, height: 500)
    ...
    let circle5 = CGRect(x: 400, y: 4000, width: 200, height: 200)
