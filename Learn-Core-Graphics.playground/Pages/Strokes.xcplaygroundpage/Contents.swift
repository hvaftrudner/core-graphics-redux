...
let rendered = renderer.image { ctx in
    ...
    let smallCircle = CGRect(x: 100, y: 400, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: smallCircle)
    ctx.cgContext.drawPath(using: .fillStroke)
    ...
    let smallCircle2 = CGRect(x: 700, y: 400, width: 200, height: 200)
    ...
    let smallCircle3 = CGRect(x: 400, y: 700, width: 200, height: 200)
    ...
    let smallCircle4 = CGRect(x: 400, y: 100, width: 200, height: 200)
